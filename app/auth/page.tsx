...
>(({ className, type, ...props }, ref) => {
	return (
		<input
			type={type}
			className='flex h-12 w-full rounded-md border border-gray-200 bg-white px-3 py-2 text-[14px] placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 disabled:opacity-50'
			ref={ref}
			{...props}
		/>
	);
...
>(({ className, ...props }, ref) => {
	return (
		<button
			className='inline-flex items-center justify-center rounded-md text-[14px] font-medium transition-colors focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 h-12 px-4 py-2 bg-indigo-600 text-white hover:bg-indigo-700'
			ref={ref}
			{...props}
		/>
	);
...
const api_base_url = "https://backend.cauhec.org/api/v1";
